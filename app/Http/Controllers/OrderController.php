...
class OrderController extends Controller
{
    ...
    public function getQrCode($id)
    {
        ...
        $ticket->order = Order::with(['customer:id,first_name,last_name', 'event:id,start_time,end_time,name,type,address', 'organization:id,image,first_name,last_name'])->find($ticket->order_id);
    ...
    public function sendMail($id)
    {
        ...
        $data["email"] = isset($order->customer->email) ? $order->customer->email : $order->email; ;
