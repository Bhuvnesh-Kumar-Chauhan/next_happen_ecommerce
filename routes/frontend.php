...
Route::group(['middleware' => ['mode', 'XSS']], function () {
    ...
    Route::get('/landing', [FrontendController::class, 'landing']);
    Route::get('/privacy_policy', [FrontendController::class, 'privacypolicy']);
    Route::get('/partners ', [FrontendController::class, 'partners']);
    Route::get('/how-we-help ', [FrontendController::class, 'how_we_help']);
    Route::get('/about', [FrontendController::class, 'about']);
    Route::get('/term-and-condition', [FrontendController::class, 'term_and_condition']);
    Route::get('/refund-and-cancellation-policy', [FrontendController::class, 'refund_and_cancellation_policy']);
    ...
    Route::group(['prefix' => 'user'], function () {
        ...
        Route::any('/stripe/create-session', [FrontendController::class, 'checkoutSession']);
    ...
    Route::group(['middleware' => 'checkStatus'], function () {
        ...
        Route::get('/ticket/{id}/{name}', [FrontendController::class, 'ticketDetail']);
