...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-8">
                    <h2 class="section-title"> {{ __('Organiser Setting') }}</h2>
                </div>
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <div class="custom-switches-stacked mt-2">
                                                <label class="custom-switch pl-0">
                                                    <input type="checkbox" name="stripe" value="1" class="custom-switch-input" {{ isset($payment) && $payment->stripe == '1' ? 'checked' : '' }}>
                                            ...
                                            <div class="custom-switches-stacked mt-2">
                                                <label class="custom-switch pl-0">
                                                    <input type="checkbox" name="paypal"
                                                        {{ isset($payment) && $payment->paypal == '1' ? 'checked' : '' }} value="1"
                                            ...
                                            <div class="custom-switches-stacked mt-2">
                                                <label class="custom-switch pl-0">
                                                    <input type="checkbox" name="flutterwave"
                                                        {{ isset($payment) && $payment->flutterwave == '1' ? 'checked' : '' }}
                                            ...
                                            <div class="custom-switches-stacked mt-2">
                                                <label class="custom-switch pl-0">
                                                    <input type="checkbox" name="razor"
                                                        {{ isset($payment) &&  $payment->razor == '1' ? 'checked' : '' }} value="1"
                                                        class="custom-switch-input">
                                                    <span class="custom-switch-indicator"></span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="stripeSecretKey"
                                                placeholder="{{ __('Stripe secret key') }}" value="{{ isset($payment) ? $payment->stripeSecretKey : '' }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="stripePublicKey"
                                                placeholder="{{ __('Stripe public key') }}" value="{{isset($payment) ? $payment->stripePublicKey : '' }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="paypalClientId"
                                                placeholder="{{ __('Paypal Client ID') }}" value="{{ isset($payment) ? $payment->paypalClientId : '' }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="paypalSecret"
                                                placeholder="{{ __('Paypal Secret key') }}" value="{{ isset($payment) ? $payment->paypalSecret  : '' }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="razorPublishKey"
                                                placeholder="{{ __('Razorpay Publish key') }}" value="{{isset($payment) ? $payment->razorPublishKey  : '' }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="razorSecretKey"
                                                placeholder="{{ __('Razorpay Secret key') }}" value="{{isset($payment) ? $payment->razorSecretKey  : '' }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="ravePublicKey"
                                                placeholder="{{ __('Flutterwave public key') }}" value="{{isset($payment) ? $payment->ravePublicKey  : '' }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" name="raveSecretKey"
                                                placeholder="{{ __('Flutterwave secret key') }}" value="{{isset($payment) ? $payment->raveSecretKey  : '' }}"
