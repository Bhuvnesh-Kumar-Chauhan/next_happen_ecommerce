        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('event-talent.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{ Carbon\Carbon::parse($event->start_time)->format('Y-m-d')}}" onchange="checkAvailability()">
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('#talent_id').append('<option value="'+ key +'">'+ value +'</option>');
                        });
