                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="customer" class="form-control select2">
                                        ...
                                        <option value="{{$item->id}}" {{isset($request->customer)==true && $request->customer==$item->id ? 'Selected':''}}>{{$item->first_name.' '.$item->last_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->order_id}}</td>
                                    <td>
                                       <h6>{{$item->customer->first_name.' '.$item->customer->last_name}}</h6>
