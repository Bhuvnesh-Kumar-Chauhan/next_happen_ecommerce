                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="media mb-3">
                                            ...
                                            if (is_array($order->event->image)) {
                                                $firstMedia = $order->event->image[0] ?? null;
                                            } elseif (is_string($order->event->image)) {
                                                if (Str::startsWith($order->event->image, '[')) {
                                                    $decoded = json_decode($order->event->image, true);
                                                    $firstMedia = is_array($decoded) ? $decoded[0] ?? null : null;
                                                } else {
                                                    $firstMedia = $order->event->image;
                                                }
                                            }
                                        ...
                                        @if ($mediaPath)
                                            @if ($isImage)
                                                <img src="{{ asset($mediaPath) }}" alt="{{ $order->event->name ?? '' }}" class="mr-3" width="50" height="50"
                                                     >
                                            @elseif ($isVideo)
                                                <video autoplay muted loop playsinline class="mr-3" width="50" height="50"
                                                       >
