            ...
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                <div class="p-4 m-3 w-10 h-10">
                    ...
                    <div class="flex justify-center pt-6">
                        <p class="text-base font-medium leading-5 text-gray font-poppins">
                            {{ __('Don’t have an account?') }}
                            <a href="{{ url('user/register') }}" class="text-primary font-semibold hover:text-primary-dark transition duration-300">
                                {{ __('Create Account') }}
                            </a>
                        </p>
                    </div>
