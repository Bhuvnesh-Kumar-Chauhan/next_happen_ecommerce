            ...
            <div class="flex items-center justify-between py-4">
                ...
                <div class="sm:flex sm:items-center">
                    <ul class="navbar-nav flex space-x-4 xxsm:max-xl:hidden">
                        ...
                        <li class="xxsm:max-lg:hidden nav-item {{ Request::is('about') ? 'active' : '' }}">
                            <a href="{{ url('/about') }}"
                                    ...
                                    <div class="rounded-md bg-white shadow-xs">
                                        <div class="py-1">
                                            ...
                                            <div class="px-3 py-5">
                                                <button type="button"
                                                    class="flex items-center  font-poppins font-medium leading-4 text-danger capitalize">
                                                    <i class="fa-solid fa-right-from-bracket mr-3"></i><span id="check-mobile"
                                                        class="flex-1  whitespace-nowrap">{{ __('Logout') }}</span>
                                                </button>
                                            </div>
                                        </div>
...
<script>
    document.getElementById("check-mobile").addEventListener('click', function() {
        Swal.fire({
            title: 'Are you sure to logout!!',
            icon: 'warning',
            showCancelButton: true,
