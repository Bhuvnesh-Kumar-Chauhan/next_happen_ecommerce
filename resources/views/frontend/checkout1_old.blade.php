                        ...
                        <div
                            ...
                            <div class="">
                                <div class="w-full shadow-lg p-6 rounded-lg flex flex-wrap bg-white mb-6">
                                    ...
                                    <div class="w-full sm:w-56 h-56 flex-shrink-0 mb-4 sm:mb-0">
                                        @if ($mediaPath)
                                            @if ($isImage)
                                                <style>
                                                    .h-56 {
                                                ...
                                                <img src="{{ asset($mediaPath) }}" alt="{{ $data->event->name ?? '' }}"
                                                     class="rounded-lg w-full h-56 object-fill">
                                            @elseif ($isVideo)
                                            <style>
                                                .h-56 {
                                                    height: 25rem;
                                                ...
                                                <video autoplay muted loop playsinline class="rounded-lg w-full h-56 object-fill">
                                    ...
                                    <!-- Event Details -->
                                    <div class="ml-0 sm:ml-6 flex-1 2xl:w-[60%] xl:w-full xlg:w-full xmd:w-full xxmd:w-[80%]">
                                        ...
                                        <p class="font-poppins font-medium text-base leading-7 text-gray text-left w-[50%]">
                                            {{ $data->event->address }}
                                        </p>
                                    ...
                                    <div class="md:w-[15%] sm:w-full pt-14 ml-auto">
                                        @if ($data->type == 'paid')
                                            <p class="font-poppins font-medium text-sm leading-7 text-danger text-left">
                                                {{ __('Paid') }}
                                            </p>
                                            <p class="font-poppins font-semibold text-3xl leading-7 text-primary text-left pt-5">
                                        ...
                                        @if ($data->seatmap_id == null || $data->module->is_enable == 0)
                                            ...
                                            <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1 pro-qty">
                                                ...
                                                <div class="text-center">
                                                    <input type="number" id="quantity" readonly name="quantity"
                                                           value="1"
                                                           class="bg-primary-light outline-none focus:outline-none text-center w-8 font-semibold text-md hover:text-black focus:text-black md:text-basecursor-default flex items-center text-primary h-8"
